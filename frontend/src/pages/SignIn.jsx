...
function SignIn() {
   ...
   return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{backgroundImage:`url(${bg})`}}>
      ...
      <h1 className='text-white text-[30px] font-semibold'>SignIn to 
      ...
      <p className='text-[white] text-[18px] cursor-pointer 'onClick={()=>navigate("/signup")}> Want to create an account ? <span className='text-blue-400'>Sign Up</span></p>
