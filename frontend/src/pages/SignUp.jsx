...
function SignUp() {
   ...
   return (
    <div className='w-full h-[100vh] bg-cover flex justify-center items-center' style={{backgroundImage:`url(${bg})`}}>
      ...
      <h1 className='text-white text-[30px] font-semibold'>Register to 
      ...
      <button className='min-w-[150px] h-[60px] mt-[30px] text-black font-semibold bg-white rounded-full text-[18px] disabled ={loading} ' >{loading? "Loading..." : "Signup"}</button>
